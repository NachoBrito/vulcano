...
public record HnswConfig(
    ...
    public static class Builder {
        ...
        /**
         * efSearch (Query Speed/Accuracy Trade-Off)5Goal: Balance the speed of the search physical (latency) with the desired
         * accuracy (recall). This parameter controls the exploration depth at the moment of the physical.
         * <p>
         * Cost: This process happens every single time a search physical is executed. The cost is high physical latency.
         * <p>
